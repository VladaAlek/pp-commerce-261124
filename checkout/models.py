...
class Order(models.Model):
    ...
    discount_cost = models.DecimalField(max_digits=6, decimal_places=2, null=False, default=0)
...
class OrderLineItem(models.Model):
    ...
    product = models.ForeignKey(Category, null=False, blank=False, on_delete=models.CASCADE)
